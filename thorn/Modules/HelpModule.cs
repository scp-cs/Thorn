...
public class HelpModule : ModuleBase<SocketCommandContext>
{
    ...
    public async Task HelpCommand(string page)
    {
        ...
        switch (page)
        {
            ...
            case "t":
            case "translating":
                help = _constants.Strings.specificHelp.translation;
                break;
            case "writing":
            case "psaní":
            case "w":
                help = _constants.Strings.specificHelp.writing;
                break;
            case "correction":
            case "korekce":
            case "c":
            case "correcting":
                help = _constants.Strings.specificHelp.correction;
                break;
            case "join":
            case "připoj-se":
            case "připojit":
            ...
            case "j":
            case "joining":
                help = _constants.Strings.specificHelp.join;
                break;
            default:
                return;
        }
