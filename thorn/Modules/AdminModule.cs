...
public class AdminModule : ModuleBase<SocketCommandContext>
{
    ...
    public async Task SayCommand([Remainder] string text)
    {
        ...
        _logger.LogInformation("{ContextUser} said \"{Text}\" in #{ContextChannel}", Context.User, text,
            Context.Channel);
    }
    ...
    public async Task VoteCommand([Remainder] string text)
    {
        ...
        _logger.LogInformation("{ContextUser} made a vote in #{ContextChannel}: {Text}", Context.User, Context.Channel,
            text);
    }
